  ...
  return (
    <>
      ...
      <style>{`
        ...
        .auth-right { background: linear-gradient(160deg, #ff4d6d 0%, #e00429 50%, #990011 100%); min-height: 500px; position: relative; }
        .auth-right::after { content:''; position:absolute; top:0; left:0; right:0; height:6px; background: linear-gradient(90deg,#ff8fa3,#ff4d6d,#ff8fa3); }
